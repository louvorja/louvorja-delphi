object fLiturgia: TfLiturgia
  ...
  object bsSkinPanel1: TbsSkinPanel
    ...
    Align = alTop
    object csCor: TbsSkinColorButton
      Tag = 7
    ...
    object cbItens: TbsSkinComboBox
      AlignWithMargins = True
      Left = 84
      Top = 5
      Width = 120
      ...
      CharCase = ecNormal
      DefaultColor = clWindow
      Text = 'Anota'#231#227'o'
      Align = alLeft
      Items.Strings = (
        'Anota'#231#227'o'
        'Arquivo/Diret'#243'rio'
        'Categoria'
        'Itens Agendados'
        'M'#250'sica'
        'Site')
  ...
  object ScrollBox1: TScrollBox
    ...
    object pnlHinos: TbsSkinPanel
      ...
      AutoSize = True
      Align = alTop
      object bsRibbonDivider10: TbsRibbonDivider
        Left = 0
        Top = 0
        Width = 669
        Height = 12
      ...
      object bsSkinPanel2: TbsSkinPanel
        ...
        Caption = 'bsSkinPanel1'
        Align = alTop
        object opcHinosOpc1: TbsSkinRadioButton
          AlignWithMargins = True
          Left = 10
          Top = 5
          Width = 242
          ...
          Checked = False
          GroupIndex = 0
          Caption = 'A m'#250'sica ser'#225' escolhida na hora'
          OnClick = opcHinosOpc1Click
          Align = alLeft
        end
      end
      object pnlHinosOpc1: TbsSkinPanel
        Left = 0
        Top = 41
        Width = 669
        Height = 31
        ...
        Caption = 'bsSkinPanel1'
        Align = alTop
        object skLitLabel: TbsSkinStdLabel
          AlignWithMargins = True
          Left = 10
          Top = 5
          Width = 36
        ...
        object bsSkinPanel4: TbsSkinPanel
          ...
          DesignSize = (
            571
            21)
          object dbLitHinoLista: TbsSkinDBLookupComboBox
            Left = 0
            Top = 0
            Width = 571
            Height = 20
    ...
    object pnlAnotacoes: TbsSkinPanel
      Left = 0
      Top = -66
      Width = 669
      Height = 41
      ...
      object bsSkinPanel6: TbsSkinPanel
        ...
        object edtAnotacao: TbsSkinEdit
          AlignWithMargins = True
          Left = 73
          Top = 5
          Width = 586
    ...
    object pnlArquivo: TbsSkinPanel
      Left = 0
      Top = 88
      Width = 669
      Height = 41
      ...
      object bsSkinPanel7: TbsSkinPanel
        ...
        object edtDiretorio: TbsSkinEdit
          AlignWithMargins = True
          Left = 150
          Top = 5
          Width = 343
          ...
          RightImageHotIndex = -1
          RightImageDownIndex = -1
          OnEnter = edtDiretorioEnter
          OnExit = edtDiretorioExit
          OnKeyUp = txtItemKeyUp
        end
        object edtDiretorioInfo: TbsSkinEdit
          AlignWithMargins = True
          Left = 109
          Top = 5
          Width = 28
    ...
    object pnlItensAgendados: TbsSkinPanel
      Left = 0
      Top = -107
      Width = 669
      Height = 41
      ...
      object bsSkinPanel8: TbsSkinPanel
        ...
        object dblItem: TDBLookupComboBox
          AlignWithMargins = True
          Left = 49
          Top = 5
          Width = 610
          ...
          KeyField = 'ID'
          ListField = 'NOME'
          ListSource = DM.dsCategoriasItensAgendados
          TabOrder = 0
        end
      end
    end
